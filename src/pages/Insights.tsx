          ...
          <div className="mt-16 text-center">
            <Card className="max-w-2xl mx-auto">
              <CardHeader>
                ...
                <CardDescription className="text-base">Subscribe to our newsletter to get the latest advertising placements, case studies, and strategies delivered to your inbox.</CardDescription>
              </CardHeader>
              <CardContent>
