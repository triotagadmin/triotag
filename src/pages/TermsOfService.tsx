        ...
        <div className="max-w-3xl mx-auto prose prose-invert">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              By accessing or using TrioTag ("the Platform"), you agree to be bound by these Terms of Service. If you do
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              All payments are processed through our secure payment system. Fees and commissions are disclosed at the
              time of transaction. Refunds are subject to our refund policy and the specific terms of each transaction.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              The Platform and its original content, features, and functionality are owned by TrioTag and are protected
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              To the maximum extent permitted by law, TrioTag shall not be liable for any indirect, incidental, special,
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              TrioTag operates, without regard to its conflict of law provisions.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              posting the new Terms on this page. Your continued use of the Platform after changes constitutes
