...
const coreServices = [
  {
    ...
    icon: MapPin,
    description:
      "Location Bundling allows Print Partners to combine multiple ad placements across strategic ad spaces into one unified campaign. Instead of booking individual placements manually, Print Partners deploy campaigns across curated ad space bundles designed for maximum exposure.",
    howItWorks: [
    ...
    bundles: [
      "Coffee Shop Network Bundle",
      "University District Bundle",
      "Business District Bundle",
      "Community Lifestyle Bundle",
    ],
    benefits: [
      "Higher reach with fewer decisions",
      "Geographic targeting",
      "Audience clustering",
      "Simplified campaign deployment",
    ],
  },
  {
    ...
    icon: Palette,
    description:
      "Our team develops the visual advertising materials used in TrioTag campaigns. We design ad creatives optimized for small-format ad space placements such as table tents, stickers, and micro signage.",
    formats: ["Vinyl Stickers", "Table Tent Cards", "Acrylic Table Tents", "Coroplast Stands"],
    process: [
      "Campaign brief review",
      "Visual concept development",
      "Design optimization for small-format visibility",
      "Print-ready production files",
      "Final creative approval",
    ],
    principles: [
      "High readability in small spaces",
  ...
  },
  {
    ...
    icon: Settings,
    description:
      "TrioTag manages the entire campaign lifecycle, from planning to deployment. Our system coordinates Print Partners, ad spaces, and placements to ensure smooth campaign execution.",
    includes: [
      "Ad space selection",
    ...
    operations: [
      "Coordinating ad space placements",
...
const roadmapSteps = [
  {
    ...
    description: "Print Partner submits campaign details through the campaign submission form.",
    details: [
      "Campaign name",
      "Contact information",
  ...
  },
  {
    ...
    description:
      "Our team reviews the campaign brief to determine best ad spaces, best ad formats, and bundle recommendations. We may contact the Print Partner for clarification.",
  },
  {
    num: "03",
    title: "Location Bundling",
    description:
      "We curate a strategic placement bundle that includes selected ad spaces, placement quantities, and geographic targeting. Print Partners receive a proposed campaign plan.",
  },
  {
    num: "04",
    title: "Creative Development",
    description:
      "Our design team prepares the advertising materials including ad layout design, format optimization, and Print Partner approval. Final files are prepared for printing.",
  },
  {
    num: "05",
    title: "Production & Deployment",
    description:
      "Ad materials are printed and deployed across selected ad spaces. Deployment includes installation coordination, placement verification, and coordination with ad space operators.",
  },
  {
    num: "06",
    title: "Campaign Activation",
    description:
      "Once placements are installed, the campaign becomes active. Print Partners receive confirmation that their ads are live across the selected ad spaces.",
  },
  {
    num: "07",
    title: "Campaign Completion",
    description:
      "At the end of the campaign, placements are removed or renewed. Print Partners can launch follow-up campaigns.",
  },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 md:py-28 bg-background relative overflow-hidden">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-40 md:w-80 h-40 md:h-80 bg-accent/10 rounded-full blur-[100px] animate-pulse"
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-primary font-semibold text-sm md:text-lg mb-3">
            Physical micro-advertising placed inside micro ad spaces like coffee shops, libraries, and retail
            environments.
          </p>
          <p className="text-muted-foreground text-xs md:text-base max-w-3xl mx-auto mb-8">
            TrioTag is a campaign management platform designed for printing companies to execute, manage, and scale
            print advertising campaigns across multiple locations.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
            <Link to="/campaign-submit">
              <Button
                size="lg"
                className="text-sm md:text-lg px-6 md:px-8 py-4 md:py-6 min-h-[44px] neon-glow hover:neon-glow-strong"
              >
                Start Your Campaign
              </Button>
            </Link>
            <a href="#how-campaigns-work">
              <Button
                size="lg"
                variant="outline"
                className="text-sm md:text-lg px-6 md:px-8 py-4 md:py-6 min-h-[44px] border-primary/50 hover:border-primary"
              >
                Learn How It Works
              </Button>
            </a>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-8 md:space-y-12">
            {coreServices.map((service, idx) => (
              <Card
                key={service.title}
                className="p-5 md:p-8 hover:shadow-[0_0_20px_hsl(var(--primary)/0.2)] transition-all duration-300"
              >
                <CardContent className="p-0">
                  ...
                  <p className="text-muted-foreground text-xs md:text-base mb-4 md:mb-6 leading-relaxed">
                    {service.description}
                  </p>
      ...
      <section className="py-12 md:py-20 bg-muted/30 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xs md:text-base text-muted-foreground mb-6 md:mb-8 max-w-xl mx-auto">
            Ready to promote your brand across real-world ad spaces? Submit your campaign and our team will begin
            planning your placement strategy.
          </p>
          <Link to="/campaign-submit">
