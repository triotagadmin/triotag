...
export default function BrandAdvertiserProductCampaigns() {
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Manage the products you promote across your retail media campaigns.</p>
          </div>
          <Button onClick={() => toast.info("Product creation is coming soon")}>
                ...
                <TableRow>
                  <TableCell colSpan={3} className="py-14">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <p className="text-gray-900 font-medium mt-3">No products yet</p>
                      <p className="text-sm text-gray-500 mt-1">Add your first product to link it to a campaign.</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : rows.map((r) => (
