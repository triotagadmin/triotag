...
export default function BrandAdvertiserEventCampaigns() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Event Campaigns</h1>
            <p className="text-sm text-gray-500 mt-1">Manage the events you promote across your retail media campaigns.</p>
          </div>
          <Button onClick={() => toast.info("Event creation is coming soon")}>
            ...
            <TableBody>
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={4} className="py-14">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <p className="text-gray-900 font-medium mt-3">No events yet</p>
                      <p className="text-sm text-gray-500 mt-1">Add your first event to link it to a campaign.</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : rows.map((r) => (
                <TableRow key={r.id}>
                  ...
                  <TableCell className="text-sm text-gray-600">{r.event_date || "—"}</TableCell>
