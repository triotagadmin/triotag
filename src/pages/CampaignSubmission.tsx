...
const AD_MATERIAL_OPTIONS = ["Vinyl Sticker", "Table Tent Card", "Table Tent Acrylic", "Coroplast Stand"];
...
const CampaignSubmission = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.adMaterials.length === 0) {
      toast({
        title: "Ad Materials Required",
        description: "Please select at least one ad material.",
        variant: "destructive",
      });
      return;
    }
    if (formData.targetLocations.length === 0) {
      toast({
        title: "Target Locations Required",
