    ...
    <section className="py-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">Featured Locations</h2>
          <p className="text-xl text-muted-foreground">Premium ad spaces in high-traffic areas</p>
        </div>
