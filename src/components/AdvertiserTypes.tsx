      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-sm px-2 text-popover-foreground md:text-base">
            Tiny Sticky Ads is a retail media platform that helps businesses and organizers distribute campaigns for
            products, services, and events. Our platform combines four key capabilities: a curated ad space marketplace,
