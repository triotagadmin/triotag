      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-sm px-2 text-popover-foreground md:text-base">
            Tiny Sticky Ads is a advertising media platform that helps businesses and organizers distribute campaigns
            for products, services, and events. Our platform has four key capabilities: a curated ad space marketplace,
            a branch location distribution system, an out-of-home (OOH) logistics platform, and a campaign analytics
            dashboard, giving brands full control over deployment and performance tracking.
          </p>
        </div>
          ...
          {advertiserTypes.map((type, index) => {
            ...
            return (
              ...
              >
                ...
                <CardContent>
                  <CardDescription className="text-xs md:text-base text-white">{type.description}</CardDescription>
                </CardContent>
              </Card>
            );
          })}
