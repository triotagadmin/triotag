...
export const Hero = () => {
  ...
  return <section className="relative min-h-[70vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        }} className="text-base text-center bg-transparent neon-text-glow animate-text-glow text-sidebar-foreground font-semibold">Advertise your products, services, events, announcements,
